<?php
include_once 'header.php';  // This is the header file
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                <form action="checkout-process.php">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            if($login->isLoggedIn()){
                                ?>
                                <h6 class="checkout__title">Account</h6>
                                <?php }else{ ?>
                            <h6 class="checkout__title">Create Account or Login</h6>
                            <?php } ?>
                         <?php
                            if($login->isLoggedIn()){
                                ?>
                        ...
                        <div class="col-lg-8 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul class="checkout__total__products">
                                    ...
                                    $total += $price;
                                    ?>
                                    <li><?php echo $product_name; ?> <span>N<?php echo $price; ?></span></li>
                                    <?php
                                    }
                                    ?>
                                </ul>
